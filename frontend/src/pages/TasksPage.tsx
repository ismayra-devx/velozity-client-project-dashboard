...
import { CheckSquare, RefreshCw, Layers } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-2 border-b border-slate-200/80">
        ...
        <div className="flex items-center gap-3">
          <button
            onClick={() => fetchTasks()}
            className="flex items-center gap-1.5 px-3.5 py-2 text-xs font-semibold text-slate-700 hover:text-slate-900 bg-white border border-slate-200 rounded-xl hover:bg-slate-50 transition-colors shadow-sm"
          >
      ...
      {loading ? (
        ...
        <div className="bg-white rounded-2xl p-16 text-center text-slate-500 border border-slate-200">
          ...
          <p className="text-sm font-semibold text-slate-800">No tasks match your filter criteria</p>
